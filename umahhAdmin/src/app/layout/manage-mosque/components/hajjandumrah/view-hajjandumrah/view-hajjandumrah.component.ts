...
@Component({
  selector: 'app-view-hajjandumrah',
  templateUrl: './view-hajjandumrah.component.html',
  styleUrls: ['./view-hajjandumrah.component.scss']
})
export class ViewHajjandumrahComponent implements OnInit {
