...
@Component({
  selector: 'app-view-quizrule',
  templateUrl: './view-quizrule.component.html',
  styleUrls: ['./view-quizrule.component.scss']
})
export class ViewQuizRuleComponent implements OnInit {
