...
@Component({
  selector: 'app-view-prayer-name',
  templateUrl: './view-prayer-name.component.html',
  styleUrls: ['./view-prayer-name.component.scss']
})
export class ViewPrayerNameComponent implements OnInit {
