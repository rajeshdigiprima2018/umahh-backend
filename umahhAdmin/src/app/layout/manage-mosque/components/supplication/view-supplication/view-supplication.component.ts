...
@Component({
  selector: 'app-view-supplication',
  templateUrl: './view-supplication.component.html',
  styleUrls: ['./view-supplication.component.scss']
})
export class ViewSupplicationComponent implements OnInit {
