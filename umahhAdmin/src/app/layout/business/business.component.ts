...
export class BusinessComponent implements OnInit {
    ...
    getBusiness() {
        ...
        this.businessService.getBusinessListing(this.dataRole).subscribe(res => {
            if (res.code == 200) {
   ...
   showConfirm() {
    ...
    deleteBusiness() {
        this.isLoading = true;
        this.businessService.deleteBusiness(this._id).subscribe(res => {
...
/*
  ...
  */
    ...
    onStatusChange(event,userId) {
      ...
      updateStatus(){
        this.displayUpdateStatus=false;
        this.businessService.updateUserStatus(this.updateStatusData).subscribe(res => {
              this.isLoading = false;
              if(res.code==200){
                this.toastr.success(res.message);
               // this.searchUser();
