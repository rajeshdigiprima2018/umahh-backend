...
var PersonnageModel = require('../Models/personnage').PersonnageModel;
...
module.exports.funcs_s = {
    ...
    getpersonnage: function (request, reply) {
        ...
        const aFunc = async function () {
            ...
            try {
                ...
                const getData = await PersonnageModel.find({"deletedAt":null});

                return reply({
                    code: 200,
                    success: true,
                    data: getData,
                    message: "Personnage list fetched successfully."
                }).code(200);

            } catch (error) {
                return reply({
                    success: false,
                    message: "Personnage not fetched"
                }).code(500);
            }
