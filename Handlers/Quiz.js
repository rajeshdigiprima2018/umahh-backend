...
var QuizModel = require('../Models/quiz').QuizModel;
...
module.exports.funcs_quiz     =   {
    ...
    getQuizByCategryId    :   function(request, reply) {
        ...
        const aFunc = async function(){
            ...
            try {
                ...
                const getAllData = await QuizModel.find({"quiz_category_id": request.params.quiz_category_id});
   ...
   getQuizByCategryIdWeb  :   function(request, reply) {
        ...
        const aFunc = async function(){
            ...
            try {
                ...
                let totCount;
                const getCount = await QuizModel.find().count();
                totCount = getCount;
                if (!request.payload.count) {
                    count = totCount;
                }

                const getAllData = await QuizModel.find()
    ...
    getQuiz    :   function(request, reply) {
        ...
        const aFunc = async function(){
            ...
            try {
                ...
                const getData = await QuizModel.findById(request.params._id);
    ...
    addQuiz    :   function(request, reply) {

        const aFunc = async function(){
            try {

                /*//add mosque Board and mosque id
                const Board = new QuizModel(request.payload);
               ...
               // if(authUser){
                    ...
                    let newObjectAdd = new QuizModel(docObject)
    ...
    deleteQuiz    :   function(request, reply) {
        ...
        const aFunc = async function(){
            ...
            try {
                ...
                const deleteData = await QuizModel.remove({_id:request.params._id});
