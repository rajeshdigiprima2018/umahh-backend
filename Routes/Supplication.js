...
const handlers_sp = require('../Handlers/Supplication').funcs_sp;
...
var arrRoutes = [
    ...
    {
        method: 'POST',
        path: '/api/web/supplication/getAll',
        handler: handlers_sp.getsupplicationWeb,
        config: {
            //auth:   'token',
            description: 'admin get all supplication.',
            notes: 'Test APi',
    ...
    {
        method: 'POST',
        path: '/api/user/addLikeSupplication/add',
        handler: handlers_sp.addLikeSupplication,
        config: {
            //auth:   'token',
            description: 'user add Like Supplication.',
            notes: 'Test APi',
            ...
            validate: {
                ...
                payload: Joi.object().keys({
                    ...
                    supplication_id: Joi.string().required(),
    ...
    {
        method: 'POST',
        path: '/api/user/getLikeSupplication',
        handler: handlers_sp.getLikeSupplication,
        config: {
            //auth:   'token',
